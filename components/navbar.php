    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <!-- Show all Paintings. -->
                <li class="nav-item">
                    <a class="nav-link" href="../paintings/select_all.php">Show all Paintings</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <?php dynamic_dropdowns('style', '../paintings/select_by_style.php'); ?>
                    </ul>
                </li>
                <!-- Paintings by Artist. -->
                <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="../paintings/select_all_edit_delete.php">Edit/Delete</a></li>
                    </ul>
                </li>
                <!-- Contact Page. -->
                <li class="nav-item">
            ...
            <!-- Search. -->
            <form class="d-flex" method="GET" action="../paintings/select_by_search.php">
